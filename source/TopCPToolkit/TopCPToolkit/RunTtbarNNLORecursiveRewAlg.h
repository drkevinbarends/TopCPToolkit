...
class RunTtbarNNLORecursiveRewAlg final : public EL::AnaAlgorithm {
 public:
  RunTtbarNNLORecursiveRewAlg(const std::string &name,
 ...
 private:
  ...
  CP::SysReadHandle<xAOD::EventInfo> m_eventInfoHandle{
      ...
      "the EventInfo container to read truth information from"};

  // output decorations
  CP::SysWriteDecorHandle<double> m_NNLO_weight_decor{
      this, "NNLO_weight", "NNLO_weight_%SYS%",
      "Output weight of the Ttbar NNLO reweighter"};
