...
class TopSpinDensityMatrixAlg final : public EL::AnaAlgorithm {
 ...
 private:
  ...
  CP::SysReadSelectionHandle m_selection{this, "eventSelection", "SetMe",
                                         "the event selection to apply"};
  CP::SysReadDecorHandle<PtEtaPhiMVector> m_top{this, "top_4vec", "",
  ...
  CP::SysReadDecorHandle<PtEtaPhiMVector> m_top_analyser{
      this, "top_analyser_4vec", "",
      "the 4-vector of the spin analyser from the top"};
  CP::SysReadDecorHandle<PtEtaPhiMVector> m_tbar_analyser{
      this, "tbar_analyser_4vec", "",
      "the 4-vector of the spin analyser from the anti-top"};
