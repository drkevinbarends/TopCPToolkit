...
float cos_theta_helicity(int sign, PtEtaPhiMVector top, PtEtaPhiMVector parent,
                         const PtEtaPhiMVector &ttbar,
                         PtEtaPhiMVector analyser) {
...
float cos_theta_helicity_plus(PtEtaPhiMVector &top, PtEtaPhiMVector &tbar,
                              const PtEtaPhiMVector &ttbar,
                              PtEtaPhiMVector &top_analyser,
                              PtEtaPhiMVector &tbar_analyser) {
...
float cos_theta_helicity_minus(PtEtaPhiMVector &top, PtEtaPhiMVector &tbar,
                               const PtEtaPhiMVector &ttbar,
                               PtEtaPhiMVector &top_analyser,
                               PtEtaPhiMVector &tbar_analyser) {
...
float cos_theta_raxis(int sign, PtEtaPhiMVector top, PtEtaPhiMVector parent,
                      const PtEtaPhiMVector &ttbar, PtEtaPhiMVector analyser) {
  ...
  float theta = analyser.Vect().Unit().Dot(
      r_vector
          .Unit());  // explicitly take a unit r_vector to make sure .Mag()==1

  return theta;
}

float cos_theta_raxis_plus(PtEtaPhiMVector &top, PtEtaPhiMVector &tbar,
                           const PtEtaPhiMVector &ttbar,
                           PtEtaPhiMVector &top_analyser,
                           PtEtaPhiMVector &tbar_analyser) {
  (void)tbar;           // Marking tbar as unused
...
float cos_theta_raxis_minus(PtEtaPhiMVector &top, PtEtaPhiMVector &tbar,
                            const PtEtaPhiMVector &ttbar,
                            PtEtaPhiMVector &top_analyser,
                            PtEtaPhiMVector &tbar_analyser) {
  (void)top_analyser;  // Marking top_analyser as unused
...
float cos_theta_transverse(int sign, PtEtaPhiMVector top,
                           PtEtaPhiMVector parent, const PtEtaPhiMVector &ttbar,
                           PtEtaPhiMVector analyser) {
  ...
  float theta = analyser.Vect().Unit().Dot(
      n_vector
          .Unit());  // explicitly take a unit n_vector to make sure .Mag()==1

  return theta;
}

float cos_theta_transverse_plus(PtEtaPhiMVector &top, PtEtaPhiMVector &tbar,
                                const PtEtaPhiMVector &ttbar,
                                PtEtaPhiMVector &top_analyser,
                                PtEtaPhiMVector &tbar_analyser) {
  (void)tbar;           // Marking tbar as unused
...
float cos_theta_transverse_minus(PtEtaPhiMVector &top, PtEtaPhiMVector &tbar,
                                 const PtEtaPhiMVector &ttbar,
                                 PtEtaPhiMVector &top_analyser,
                                 PtEtaPhiMVector &tbar_analyser) {
  (void)top_analyser;  // Marking top_analyser as unused
...
float cos_phi(PtEtaPhiMVector top, PtEtaPhiMVector tbar,
              const PtEtaPhiMVector &ttbar, PtEtaPhiMVector top_analyser,
              PtEtaPhiMVector tbar_analyser) {
...
float cos_theta_x(const PtEtaPhiMVector &ttbar, PtEtaPhiMVector parent,
                  PtEtaPhiMVector analyser) {
...
float cos_theta_y(const PtEtaPhiMVector &ttbar, PtEtaPhiMVector parent,
                  PtEtaPhiMVector analyser) {
...
float cos_theta_z(const PtEtaPhiMVector &ttbar, PtEtaPhiMVector parent,
                  PtEtaPhiMVector analyser) {
