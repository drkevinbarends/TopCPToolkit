...
static const std::map<std::string, SampleId> strToSampleId{
    {"Nominal", SampleId::Nominal},       {"PH7new", SampleId::PH7new},
    {"aMCH7", SampleId::aMCH7},           {"PH7", SampleId::PH7},
    {"aMCP8", SampleId::aMCP8},           {"PP8hdamp", SampleId::PP8hdamp},
    {"PP8muRup", SampleId::PP8muRup},     {"PP8muRdown", SampleId::PP8muRdown},
    {"PP8muFup", SampleId::PP8muFup},     {"PP8muFdown", SampleId::PP8muFdown},
    {"PP8FSRup", SampleId::PP8FSRup},     {"PP8FSRdown", SampleId::PP8FSRdown},
    {"PP8pthard1", SampleId::PP8pthard1}, {"MECoff", SampleId::MECoff}};
...
enum RewType { Rew2D = 1, Rew3D = 2 };

static const std::map<std::string, RewType> strToRewType{
    {"2D", RewType::Rew2D}, {"3D", RewType::Rew3D}};
