...
// class TtbarNNLORecursiveRew : public virtual asg::AsgTool, public virtual
// CP::ISystematicsTool {
class TtbarNNLORecursiveRew : public virtual asg::AsgTool,
                              public virtual CP::IReentrantSystematicsTool {
 public:
  // Constructor
  ...
  // virtual StatusCode applySystematicVariation(const CP::SystematicSet&
  // systConfig) override;
  ...
  double GetSysWeight(const CP::SystematicSet& sys, double Top_pt,
                      double ATop_pt, double TTbar_M, double TTbar_Pt = -1);
