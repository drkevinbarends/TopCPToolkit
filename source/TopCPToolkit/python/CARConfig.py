...
CAR_branches = {
    "HWW": [
        "MC_Hdecay1_decay1_beforeFSR_CAR_pt",
        "MC_Hdecay1_decay1_beforeFSR_CAR_eta",
        "MC_Hdecay1_decay1_beforeFSR_CAR_phi",
        "MC_Hdecay1_decay1_beforeFSR_CAR_m",
        "MC_Hdecay1_decay1_beforeFSR_CAR_pdgId",
        "MC_Hdecay1_decay2_beforeFSR_CAR_pt",
        "MC_Hdecay1_decay2_beforeFSR_CAR_eta",
        "MC_Hdecay1_decay2_beforeFSR_CAR_phi",
        "MC_Hdecay1_decay2_beforeFSR_CAR_m",
        "MC_Hdecay1_decay2_beforeFSR_CAR_pdgId",
        "MC_Hdecay2_decay1_beforeFSR_CAR_pt",
        "MC_Hdecay2_decay1_beforeFSR_CAR_eta",
        "MC_Hdecay2_decay1_beforeFSR_CAR_phi",
        "MC_Hdecay2_decay1_beforeFSR_CAR_m",
        "MC_Hdecay2_decay1_beforeFSR_CAR_pdgId",
        "MC_Hdecay2_decay2_beforeFSR_CAR_pt",
        "MC_Hdecay2_decay2_beforeFSR_CAR_eta",
        "MC_Hdecay2_decay2_beforeFSR_CAR_phi",
        "MC_Hdecay2_decay2_beforeFSR_CAR_m",
        "MC_Hdecay2_decay2_beforeFSR_CAR_pdgId",
        "MC_Hdecay1_decay1_afterFSR_CAR_pt",
        "MC_Hdecay1_decay1_afterFSR_CAR_eta",
        "MC_Hdecay1_decay1_afterFSR_CAR_phi",
        "MC_Hdecay1_decay1_afterFSR_CAR_m",
        ...
        "MC_Hdecay1_decay2_afterFSR_CAR_m",
        ...
        "MC_Hdecay2_decay1_afterFSR_CAR_m",
        ...
        "MC_Hdecay2_decay2_afterFSR_CAR_m",
...
class CARConfig(ConfigBlock):
    ...
    def makeAlgs(self, config):
        ...
        if self.history not in ["HWW", "HZZ"]:
